...
<section class="section">
    ...
    <div class="col-lg-4 col-md-12 col-12 col-sm-12">
        ...
        <div class="card-body">
            ...
            <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-1.png" alt="avatar">
            ...
            <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-2.png" alt="avatar">
                <div class="media-body">
            ...
            <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-3.png" alt="avatar">
                <div class="media-body">
            ...
            <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-4.png" alt="avatar">
                <div class="media-body">
    ...
    <div class="col-lg-6 col-md-6 col-12">
        ...
        <div class="card-body">
            ...
            <li class="media">
                ...
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-5.png" alt="avatar">
                <div class="media-body">
        ...
        <div class="card-body p-0">
            ...
            <table class="table table-striped mb-0">
                ...
                <tr>
                    ...
                    <td>
                    <a href="#" class="font-weight-600"><img src="<?= base_url() ?>dashboard_assets/assets/img/avatar/avatar-1.png" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                    </td>
                    <td>
...
<!-- JS Libraies -->
{{-- <script src="<?= base_url() ?>dashboard_assets/node_modules/simpleweather/jquery.simpleWeather.min.js"></script>
<script src="<?= base_url() ?>dashboard_assets/node_modules/chart.js/dist/Chart.min.js"></script>
<script src="<?= base_url() ?>dashboard_assets/node_modules/jqvmap/dist/jquery.vmap.min.js"></script>
<script src="<?= base_url() ?>dashboard_assets/node_modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
<script src="<?= base_url() ?>dashboard_assets/node_modules/summernote/dist/summernote-bs4.js"></script>
<script src="<?= base_url() ?>dashboard_assets/node_modules/chocolat/dist/js/jquery.chocolat.min.js"></script> --}}
</body>
</html>
