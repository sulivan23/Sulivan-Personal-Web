<?php echo $__env->make('dashboard/v_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <head>
     ...
     <title><?php echo e($title); ?> - Configurable</title>
       <!-- CSS Libraries -->
                  ...
                  <a href="#add" class="btn btn-primary mb-4" id="add_data"><i class="fa fa-plus"></i> Add Configurable</a>
                    <div class="table-responsive">
                      ...
                      <input type="hidden" class="form-control security_token" name="<?php echo e($token_name); ?>" value="<?php echo e($token); ?>">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $get_configurable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($data->data_id); ?></td>
                                <td><?php echo e($data->value); ?></td>
                                <td><?php echo e($data->description); ?></td>
                                <td><?php echo e($data->content); ?></td>
                                <td>
                                    <a onclick="popUpUpdate(<?php echo e($data->data_id); ?>, 'conf');" class="btn btn-primary text-white"><i class="fa fa-edit"></i></a>
                                    <a onclick="deleteData(<?php echo e($data->data_id); ?>)" class="btn btn-danger text-white"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('dashboard/v_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/akukamu/application/views/dashboard/configurable.blade.php ENDPATH**/ ?>