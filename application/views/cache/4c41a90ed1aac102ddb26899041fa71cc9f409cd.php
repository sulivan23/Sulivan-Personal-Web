<?php echo $__env->make('dashboard/v_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <head>
     ...
     <title><?php echo e($title); ?> - Internship</title>
       <!-- CSS Libraries -->
                  ...
                  <a href="#add" class="btn btn-primary mb-4" id="add_data"><i class="fa fa-plus"></i> Add Internship</a>
                    <div class="table-responsive">
                      ...
                      <input type="hidden" class="form-control security_token" name="<?php echo e($token_name); ?>" value="<?php echo e($token); ?>">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $get_intern; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><input type="radio" id="radioButton" name="radio" value="<?php echo e($data->internship_id); ?>"></td>
                                <td><?php echo e($data->internship_id); ?></td>
                                <td><?php echo e($data->company); ?></td>
                                <td><?php echo e($data->start_year); ?></td>
                                <td><?php echo e($data->finish_year); ?></td>
                                <td><?php echo e($data->description); ?></td>
                                <td><?php echo e($data->internship_position); ?></td>
                                <td><?php echo e(date('d F Y', strtotime($data->date_time))); ?></td>
                                <td>
                                    <a onclick="popUpUpdate(<?php echo e($data->internship_id); ?>, 'intern');" class="btn btn-primary text-white"><i class="fa fa-edit"></i></a>
                                    <a onclick="deleteData(<?php echo e($data->internship_id); ?>, 'intern')" class="btn btn-danger text-white"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('dashboard/v_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/akukamu/application/views/dashboard/internship.blade.php ENDPATH**/ ?>